LinkLuaModifier("modifier_kobold_tunneler_disarm_custom", "abilities/neutral_kobold_custom", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_kobold_tunneler_disarm_custom_debuff", "abilities/neutral_kobold_custom", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_kobold_taskmaster_command_aura_custom", "abilities/neutral_kobold_custom", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_kobold_taskmaster_command_aura_custom_effect", "abilities/neutral_kobold_custom", LUA_MODIFIER_MOTION_NONE)
