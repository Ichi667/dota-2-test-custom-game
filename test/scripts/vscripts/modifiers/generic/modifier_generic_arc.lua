...
function modifier_generic_arc:IsHidden() return true end
function modifier_generic_arc:IsDebuff() return false end
function modifier_generic_arc:IsStunDebuff() return false end
function modifier_generic_arc:IsPurgable() return false end
