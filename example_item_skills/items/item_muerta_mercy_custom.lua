...
function modifier_item_muerta_mercy_custom_stats:DeathEvent(params)
if not IsServer() then return end
...
function modifier_item_muerta_mercy_custom_stats:GetModifierProcAttack_Feedback(params)
if not IsServer() then return end
