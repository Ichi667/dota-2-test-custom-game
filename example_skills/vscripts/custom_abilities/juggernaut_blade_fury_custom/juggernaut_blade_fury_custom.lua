...
LinkLuaModifier("modifier_juggernaut_blade_fury_custom", "custom_abilities/juggernaut_blade_fury_custom/modifier_juggernaut_blade_fury_custom", LUA_MODIFIER_MOTION_NONE)
