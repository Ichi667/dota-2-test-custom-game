LinkLuaModifier("modifier_item_woodsplitter_axe_2", "items/item_woodsplitter_axe_2", LUA_MODIFIER_MOTION_NONE)

item_woodsplitter_axe_2 = class({})

function item_woodsplitter_axe_2:GetIntrinsicModifierName()
    return "modifier_item_woodsplitter_axe_2"
end

function item_woodsplitter_axe_2:OnSpellStart()
...
function modifier_item_woodsplitter_axe_2:IsPurgable()
    return false
end

function modifier_item_woodsplitter_axe_2:RemoveOnDeath()
    return false
end

function modifier_item_woodsplitter_axe_2:GetAttributes()
...
function modifier_item_woodsplitter_axe_2:GetModifierPreAttack_BonusDamage()
    local parent = self:GetParent()
...
function modifier_item_woodsplitter_axe_2:OnAttackLanded(params)
