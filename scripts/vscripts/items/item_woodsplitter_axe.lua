LinkLuaModifier("modifier_item_woodsplitter_axe", "items/item_woodsplitter_axe", LUA_MODIFIER_MOTION_NONE)

item_woodsplitter_axe = class({})

function item_woodsplitter_axe:GetIntrinsicModifierName()
    return "modifier_item_woodsplitter_axe"
end

function item_woodsplitter_axe:OnSpellStart()
...
modifier_item_woodsplitter_axe = class({})
...
function modifier_item_woodsplitter_axe:IsHidden()
    return true
end

function modifier_item_woodsplitter_axe:IsPurgable()
    return false
end

function modifier_item_woodsplitter_axe:RemoveOnDeath()
    return false
end

function modifier_item_woodsplitter_axe:GetAttributes()
    return MODIFIER_ATTRIBUTE_MULTIPLE
end

function modifier_item_woodsplitter_axe:IsPrimaryCleaveSource()
...
function modifier_item_woodsplitter_axe:DeclareFunctions()
    return
    {
...
function modifier_item_woodsplitter_axe:GetModifierPreAttack_BonusDamage()
    local parent = self:GetParent()
...
function modifier_item_woodsplitter_axe:OnAttackLanded(params)
